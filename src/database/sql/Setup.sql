...
DROP CONSTRAINT fk_schedule_syear;

ALTER TABLE SCHEDULE
ADD CONSTRAINT fk_schedule_syear
FOREIGN KEY (syear)
REFERENCES SCHOOLYEAR (syear)
ON DELETE CASCADE;

ALTER TABLE GRADES
DROP CONSTRAINT fk_grades_syear;

ALTER TABLE GRADES
ADD CONSTRAINT fk_grades_syear
FOREIGN KEY (syear)
REFERENCES SCHOOLYEAR (syear)
ON DELETE CASCADE;
...
-- d
ALTER TABLE SCHEDULE
DROP CONSTRAINT fk_schedule_semester;
...
--d
ALTER TABLE COURSE
DROP CONSTRAINT fk_course_college;
...
ALTER TABLE SUBJECT
DROP CONSTRAINT fk_subject_college;

ALTER TABLE SUBJECT
ADD CONSTRAINT fk_subject_college
FOREIGN KEY (college_code)
REFERENCES COLLEGE (college_code)
ON DELETE CASCADE;

ALTER TABLE SCHEDULE
DROP CONSTRAINT fk_schedule_college;

ALTER TABLE SCHEDULE
ADD CONSTRAINT fk_schedule_college
FOREIGN KEY (college_code)
REFERENCES COLLEGE (college_code)
ON DELETE CASCADE;
--d
...
--d
ALTER TABLE SCHEDULE
DROP CONSTRAINT fk_schedule_employee;
