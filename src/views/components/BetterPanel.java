...
public class BetterPanel extends JPanel {
    ...
    protected void paintComponent(Graphics g) {
        ...
        g2d.fillRoundRect((getWidth() - width) / 2, (getHeight() - height) / 2, width + 2, height + 2, cornerRadius, cornerRadius);
        
        if (!borderColor.equals(Color.ORANGE)) {
            g2d.setColor(borderColor);
            g2d.drawRoundRect((getWidth() - width) / 2, (getHeight() - height) / 2, width + 1, height + 1, cornerRadius - 2, cornerRadius - 2);
        }
        g2d.dispose();
        this.repaint();
    }
    ...
    public static void main(String[] args) {
        ...
        BetterPanel panel1 = new BetterPanel(200, 100, Color.BLUE, 13);
        ...
        BetterPanel panel2 = new BetterPanel(150, 150, Color.GREEN, 2);
        ...
        BetterPanel panel3 = new BetterPanel(300, 200, Color.ORANGE, 50);
