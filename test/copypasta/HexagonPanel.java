...
public class HexagonPanel extends JPanel {
    ...
    public HexagonPanel(int radius, String imagePath, Color color) {
        this.radius = radius;
    ...
    public static void main(String[] args) {
        ...
        // Add the custom hexagon panel to the frame
        frame.add(new HexagonPanel(20, "C:\\Users\\Raphael\\Downloads\\option.png", Color.BLUE), BorderLayout.CENTER);
