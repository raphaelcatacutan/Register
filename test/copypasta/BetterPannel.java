...
public class BetterPannel extends JPanel {
    ...
    public BetterPannel(int width, int height, Color background, int cornerRadius) {
        this.width = width;
        this.height = height;
    ...
    public BetterPannel(int width, int height, Color background, int cornerRadius, float glowOpacity) {
        this.width = width;
        this.height = height;
        this.panelColor = background;
        this.cornerRadius = cornerRadius;
    ...
    public BetterPannel(int width, int height, Color background, int cornerRadius, float glowOpacity, Color borderColor) {
        this.width = width;
        this.height = height;
        this.panelColor = background;
        this.cornerRadius = cornerRadius;
    ...
    public BetterPannel(int width, int height, Color background, int cornerRadius, boolean shouldGlow) {
        this.width = width;
        this.height = height;
        this.panelColor = background;
        this.cornerRadius = cornerRadius;
    ...
    protected void paintComponent(Graphics g) {
        ...
        if (shouldGlow) g2d.drawImage(glowImage, x, y, this);
    ...
    public BufferedImage generateGlow(BufferedImage imgSource, int size, Color color, float alpha) {
        ...
        g2.setColor(color);
        g2.fillRoundRect(x, y, imgSource.getWidth(), imgSource.getHeight(), cornerRadius, cornerRadius);
        g2.dispose();
    ...
    public static void main(String[] args) {
        ...
        BetterPannel panel1 = new BetterPannel(200, 100, Color.BLUE, 13);
        ...
        BetterPannel panel2 = new BetterPannel(150, 150, Color.GREEN, 2);
        ...
        BetterPannel panel3 = new BetterPannel(300, 200, Color.ORANGE, 50);
